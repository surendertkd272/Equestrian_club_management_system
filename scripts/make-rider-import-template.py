...
LINES = [
    ...
    ("p", "2.  In Equiwings: Riders → Bulk Upload Riders, and choose this .xlsx file directly."),
    ("p", "    Do NOT Save As → CSV first. Excel rewrites dates on CSV export (2014-08-23 comes"),
    ("p", "    back as 23-08-2014) and every one of those rows is then rejected."),
    ("p", "3.  Press Preview first. It reports duplicates and bad rows WITHOUT saving anything."),
    ("p", "4.  Fix the rows it names, then press Import."),
    ("", ""),
