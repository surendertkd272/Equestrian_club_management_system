...
-- CreateTable
CREATE TABLE "MonthlySkillCatalog" (
    "id" TEXT NOT NULL,
    "centreId" TEXT NOT NULL,
    ...
    CONSTRAINT "MonthlySkillCatalog_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "MonthlySkillMark" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "MonthlySkillMark_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "SeparationNotice" (
    ...
    CONSTRAINT "SeparationNotice_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Rider" (
    ...
    "indemnityVersion" TEXT,
    "indemnityConsentJson" JSONB,
    "tcsAcceptedAt" TIMESTAMP(3),
    "tcsVersion" TEXT,
    "rulesAcceptedAt" TIMESTAMP(3),
    "rulesVersion" TEXT,
    "parentalConsentJson" JSONB,
...
CREATE TABLE "HorseTest" (
    ...
    CONSTRAINT "HorseTest_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "VetPrescription" (
    ...
    CONSTRAINT "VetPrescription_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "DressageTest" (
    ...
    "movementsJson" JSONB NOT NULL,
    "collectiveMarksJson" JSONB,
...
CREATE TABLE "EquipmentStock" (
    ...
    "catalogId" TEXT NOT NULL,
    "qty" INTEGER NOT NULL DEFAULT 0,
    "qtyUnused" INTEGER NOT NULL DEFAULT 0,
    "qtyInUse" INTEGER NOT NULL DEFAULT 0,
    "qtyForRepair" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "Vendor" (
    "id" TEXT NOT NULL,
    "centreId" TEXT NOT NULL,
    "deliveryScope" TEXT NOT NULL DEFAULT 'centre',
    "name" TEXT NOT NULL,
    "category" TEXT NOT NULL DEFAULT 'other',
    "categorySpecificJson" JSONB,
    "contactName" TEXT,
    "phone" TEXT,
    "email" TEXT,
    "address" TEXT,
...
CREATE TABLE "HqExpense" (
    ...
    CONSTRAINT "HqExpense_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "StaffGateEvent" (
    "id" TEXT NOT NULL,
    "centreId" TEXT NOT NULL,
    ...
    CONSTRAINT "StaffGateEvent_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Requisition" (
    ...
    "managerNotes" TEXT,
    "accountantDecidedByUserId" TEXT,
    "accountantDecidedAt" TIMESTAMP(3),
...
CREATE TABLE "SalaryPayment" (
    ...
    "attendanceDeducted" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "absentDays" INTEGER NOT NULL DEFAULT 0,
    "deductionBreakdownJson" JSONB,
...
CREATE TABLE "PayrollConfig" (
    "id" TEXT NOT NULL,
    "orgId" TEXT NOT NULL,
    "deductionRulesJson" JSONB NOT NULL DEFAULT '{}',
...
-- CreateTable
CREATE TABLE "CoachDailyUpdate" (
    "id" TEXT NOT NULL,
    "centreId" TEXT NOT NULL,
    "coachUserId" TEXT NOT NULL,
    "date" TIMESTAMP(3) NOT NULL,
    "summary" TEXT NOT NULL,
    "horsesWorked" INTEGER,
    "ridersTaught" INTEGER,
    "injuriesNoted" TEXT,
    "minutesSpent" INTEGER,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "CoachDailyUpdate_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "VenueTrip" (
    "id" TEXT NOT NULL,
    "centreId" TEXT NOT NULL,
    ...
    CONSTRAINT "VenueTrip_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "TripChecklistItem" (
    ...
    "category" TEXT NOT NULL,
    "label" TEXT NOT NULL,
    "qtyExpected" INTEGER NOT NULL DEFAULT 1,
...
-- CreateTable
CREATE TABLE "BatchShiftRequest" (
    "id" TEXT NOT NULL,
    "riderId" TEXT NOT NULL,
    "kind" TEXT NOT NULL,
    "fromBatchId" TEXT,
    ...
    CONSTRAINT "BatchShiftRequest_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "LegalText_orgId_kind_publishedAt_idx" ON "LegalText"("orgId", "kind", "publishedAt");

-- CreateIndex
CREATE UNIQUE INDEX "LegalText_orgId_kind_version_key" ON "LegalText"("orgId", "kind", "version");

-- CreateIndex
CREATE INDEX "ChecklistTemplate_centreId_idx" ON "ChecklistTemplate"("centreId");

-- CreateIndex
CREATE UNIQUE INDEX "ChecklistTemplate_centreId_scope_key" ON "ChecklistTemplate"("centreId", "scope");

-- CreateIndex
CREATE INDEX "ChecklistItem_templateId_orderIndex_idx" ON "ChecklistItem"("templateId", "orderIndex");

-- CreateIndex
CREATE INDEX "ChecklistSubmission_centreId_submittedAt_idx" ON "ChecklistSubmission"("centreId", "submittedAt");

-- CreateIndex
CREATE INDEX "ChecklistSubmission_templateId_submittedAt_idx" ON "ChecklistSubmission"("templateId", "submittedAt");

-- CreateIndex
CREATE INDEX "ChecklistSubmission_horseId_idx" ON "ChecklistSubmission"("horseId");

-- CreateIndex
CREATE INDEX "ChecklistSubmissionItem_submissionId_idx" ON "ChecklistSubmissionItem"("submissionId");

-- CreateIndex
CREATE INDEX "ChecklistSubmissionItem_itemId_idx" ON "ChecklistSubmissionItem"("itemId");

-- CreateIndex
CREATE INDEX "DewormingSchedule_horseId_scheduledAt_idx" ON "DewormingSchedule"("horseId", "scheduledAt");

-- CreateIndex
CREATE INDEX "MonthlySkillCatalog_centreId_yearMonth_idx" ON "MonthlySkillCatalog"("centreId", "yearMonth");

-- CreateIndex
CREATE UNIQUE INDEX "MonthlySkillCatalog_centreId_yearMonth_skillLabel_key" ON "MonthlySkillCatalog"("centreId", "yearMonth", "skillLabel");

-- CreateIndex
CREATE INDEX "MonthlySkillMark_riderId_markedAt_idx" ON "MonthlySkillMark"("riderId", "markedAt");

-- CreateIndex
CREATE UNIQUE INDEX "MonthlySkillMark_catalogId_riderId_key" ON "MonthlySkillMark"("catalogId", "riderId");

-- CreateIndex
CREATE INDEX "EmployeeAdvance_userId_status_idx" ON "EmployeeAdvance"("userId", "status");

-- CreateIndex
CREATE INDEX "EmployeeAdvance_centreId_status_idx" ON "EmployeeAdvance"("centreId", "status");

-- CreateIndex
CREATE INDEX "AdvanceRepayment_advanceId_deductedAt_idx" ON "AdvanceRepayment"("advanceId", "deductedAt");

-- CreateIndex
CREATE INDEX "SeparationNotice_userId_issuedAt_idx" ON "SeparationNotice"("userId", "issuedAt");

-- CreateIndex
CREATE INDEX "SeparationNotice_status_idx" ON "SeparationNotice"("status");
...
-- CreateIndex
CREATE INDEX "User_centreId_status_idx" ON "User"("centreId", "status");
...
-- CreateIndex
CREATE INDEX "Rider_centreId_status_idx" ON "Rider"("centreId", "status");
...
-- CreateIndex
CREATE INDEX "HorseTest_horseId_testType_testedAt_idx" ON "HorseTest"("horseId", "testType", "testedAt");
...
-- CreateIndex
CREATE INDEX "VetVisit_horseId_visitDate_idx" ON "VetVisit"("horseId", "visitDate");

-- CreateIndex
CREATE INDEX "VetVisit_centreId_visitDate_idx" ON "VetVisit"("centreId", "visitDate");

-- CreateIndex
CREATE INDEX "VetPrescription_visitId_idx" ON "VetPrescription"("visitId");

-- CreateIndex
CREATE INDEX "VetPrescription_medicineId_idx" ON "VetPrescription"("medicineId");

-- CreateIndex
CREATE INDEX "Task_centreId_assignedById_idx" ON "Task"("centreId", "assignedById");

-- CreateIndex
CREATE INDEX "Task_centreId_assigneeId_idx" ON "Task"("centreId", "assigneeId");
...
-- CreateIndex
CREATE INDEX "HqExpense_orgId_spentAt_idx" ON "HqExpense"("orgId", "spentAt");

-- CreateIndex
CREATE INDEX "StaffGateEvent_centreId_occurredAt_idx" ON "StaffGateEvent"("centreId", "occurredAt");

-- CreateIndex
CREATE INDEX "StaffGateEvent_staffUserId_occurredAt_idx" ON "StaffGateEvent"("staffUserId", "occurredAt");

-- CreateIndex
CREATE UNIQUE INDEX "ShortLink_code_key" ON "ShortLink"("code");

-- CreateIndex
CREATE INDEX "ShortLink_centreId_createdAt_idx" ON "ShortLink"("centreId", "createdAt");

-- CreateIndex
CREATE INDEX "Requisition_centreId_stage_idx" ON "Requisition"("centreId", "stage");

-- CreateIndex
CREATE INDEX "Requisition_requestedByUserId_idx" ON "Requisition"("requestedByUserId");
...
-- CreateIndex
CREATE INDEX "SalaryPayment_centreId_periodMonth_idx" ON "SalaryPayment"("centreId", "periodMonth");

-- CreateIndex
CREATE UNIQUE INDEX "SalaryPayment_userId_periodMonth_key" ON "SalaryPayment"("userId", "periodMonth");

-- CreateIndex
CREATE INDEX "SalaryStructure_userId_effectiveFrom_idx" ON "SalaryStructure"("userId", "effectiveFrom");

-- CreateIndex
CREATE INDEX "SalaryStructure_centreId_idx" ON "SalaryStructure"("centreId");

-- CreateIndex
CREATE UNIQUE INDEX "PayrollConfig_orgId_key" ON "PayrollConfig"("orgId");

-- CreateIndex
CREATE INDEX "CoachDailyUpdate_centreId_date_idx" ON "CoachDailyUpdate"("centreId", "date");

-- CreateIndex
CREATE UNIQUE INDEX "CoachDailyUpdate_centreId_coachUserId_date_key" ON "CoachDailyUpdate"("centreId", "coachUserId", "date");

-- CreateIndex
CREATE INDEX "VenueTrip_centreId_departureAt_idx" ON "VenueTrip"("centreId", "departureAt");

-- CreateIndex
CREATE INDEX "VenueTrip_status_idx" ON "VenueTrip"("status");

-- CreateIndex
CREATE INDEX "TripChecklistItem_tripId_idx" ON "TripChecklistItem"("tripId");

-- CreateIndex
CREATE INDEX "AuditRun_centreId_startedAt_idx" ON "AuditRun"("centreId", "startedAt");

-- CreateIndex
CREATE INDEX "AuditRun_status_idx" ON "AuditRun"("status");

-- CreateIndex
CREATE INDEX "AuditItem_runId_idx" ON "AuditItem"("runId");

-- CreateIndex
CREATE INDEX "NotificationDispatchLog_channel_createdAt_idx" ON "NotificationDispatchLog"("channel", "createdAt");

-- CreateIndex
CREATE INDEX "NotificationDispatchLog_createdAt_idx" ON "NotificationDispatchLog"("createdAt");

-- CreateIndex
CREATE INDEX "BatchShiftRequest_riderId_status_idx" ON "BatchShiftRequest"("riderId", "status");

-- CreateIndex
CREATE INDEX "BatchShiftRequest_toBatchId_status_idx" ON "BatchShiftRequest"("toBatchId", "status");

-- CreateIndex
CREATE INDEX "BatchShiftRequest_status_createdAt_idx" ON "BatchShiftRequest"("status", "createdAt");

-- AddForeignKey
ALTER TABLE "LegalText" ADD CONSTRAINT "LegalText_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "Organisation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ChecklistTemplate" ADD CONSTRAINT "ChecklistTemplate_centreId_fkey" FOREIGN KEY ("centreId") REFERENCES "Centre"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ChecklistSubmission" ADD CONSTRAINT "ChecklistSubmission_centreId_fkey" FOREIGN KEY ("centreId") REFERENCES "Centre"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ChecklistSubmission" ADD CONSTRAINT "ChecklistSubmission_horseId_fkey" FOREIGN KEY ("horseId") REFERENCES "Horse"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ChecklistSubmissionItem" ADD CONSTRAINT "ChecklistSubmissionItem_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "ChecklistItem"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DewormingSchedule" ADD CONSTRAINT "DewormingSchedule_horseId_fkey" FOREIGN KEY ("horseId") REFERENCES "Horse"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MonthlySkillCatalog" ADD CONSTRAINT "MonthlySkillCatalog_centreId_fkey" FOREIGN KEY ("centreId") REFERENCES "Centre"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MonthlySkillMark" ADD CONSTRAINT "MonthlySkillMark_catalogId_fkey" FOREIGN KEY ("catalogId") REFERENCES "MonthlySkillCatalog"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MonthlySkillMark" ADD CONSTRAINT "MonthlySkillMark_riderId_fkey" FOREIGN KEY ("riderId") REFERENCES "Rider"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "EmployeeAdvance" ADD CONSTRAINT "EmployeeAdvance_centreId_fkey" FOREIGN KEY ("centreId") REFERENCES "Centre"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AdvanceRepayment" ADD CONSTRAINT "AdvanceRepayment_advanceId_fkey" FOREIGN KEY ("advanceId") REFERENCES "EmployeeAdvance"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SeparationNotice" ADD CONSTRAINT "SeparationNotice_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SeparationNotice" ADD CONSTRAINT "SeparationNotice_centreId_fkey" FOREIGN KEY ("centreId") REFERENCES "Centre"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "HorseTest" ADD CONSTRAINT "HorseTest_horseId_fkey" FOREIGN KEY ("horseId") REFERENCES "Horse"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "VetVisit" ADD CONSTRAINT "VetVisit_centreId_fkey" FOREIGN KEY ("centreId") REFERENCES "Centre"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "VetVisit" ADD CONSTRAINT "VetVisit_vetUserId_fkey" FOREIGN KEY ("vetUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VetPrescription" ADD CONSTRAINT "VetPrescription_visitId_fkey" FOREIGN KEY ("visitId") REFERENCES "VetVisit"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VetPrescription" ADD CONSTRAINT "VetPrescription_medicineId_fkey" FOREIGN KEY ("medicineId") REFERENCES "Medicine"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "HqExpense" ADD CONSTRAINT "HqExpense_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "Organisation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HqExpense" ADD CONSTRAINT "HqExpense_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "ExpenseCategory"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffGateEvent" ADD CONSTRAINT "StaffGateEvent_centreId_fkey" FOREIGN KEY ("centreId") REFERENCES "Centre"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffGateEvent" ADD CONSTRAINT "StaffGateEvent_staffUserId_fkey" FOREIGN KEY ("staffUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ShortLink" ADD CONSTRAINT "ShortLink_centreId_fkey" FOREIGN KEY ("centreId") REFERENCES "Centre"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Requisition" ADD CONSTRAINT "Requisition_centreId_fkey" FOREIGN KEY ("centreId") REFERENCES "Centre"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Requisition" ADD CONSTRAINT "Requisition_requestedByUserId_fkey" FOREIGN KEY ("requestedByUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SalaryPayment" ADD CONSTRAINT "SalaryPayment_centreId_fkey" FOREIGN KEY ("centreId") REFERENCES "Centre"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SalaryStructure" ADD CONSTRAINT "SalaryStructure_centreId_fkey" FOREIGN KEY ("centreId") REFERENCES "Centre"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PayrollConfig" ADD CONSTRAINT "PayrollConfig_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "Organisation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CoachDailyUpdate" ADD CONSTRAINT "CoachDailyUpdate_centreId_fkey" FOREIGN KEY ("centreId") REFERENCES "Centre"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CoachDailyUpdate" ADD CONSTRAINT "CoachDailyUpdate_coachUserId_fkey" FOREIGN KEY ("coachUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VenueTrip" ADD CONSTRAINT "VenueTrip_centreId_fkey" FOREIGN KEY ("centreId") REFERENCES "Centre"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TripChecklistItem" ADD CONSTRAINT "TripChecklistItem_tripId_fkey" FOREIGN KEY ("tripId") REFERENCES "VenueTrip"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AuditRun" ADD CONSTRAINT "AuditRun_centreId_fkey" FOREIGN KEY ("centreId") REFERENCES "Centre"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AuditRun" ADD CONSTRAINT "AuditRun_inspectorUserId_fkey" FOREIGN KEY ("inspectorUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AuditItem" ADD CONSTRAINT "AuditItem_runId_fkey" FOREIGN KEY ("runId") REFERENCES "AuditRun"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BatchShiftRequest" ADD CONSTRAINT "BatchShiftRequest_riderId_fkey" FOREIGN KEY ("riderId") REFERENCES "Rider"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BatchShiftRequest" ADD CONSTRAINT "BatchShiftRequest_fromBatchId_fkey" FOREIGN KEY ("fromBatchId") REFERENCES "Batch"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BatchShiftRequest" ADD CONSTRAINT "BatchShiftRequest_toBatchId_fkey" FOREIGN KEY ("toBatchId") REFERENCES "Batch"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BatchShiftRequest" ADD CONSTRAINT "BatchShiftRequest_decidedByUserId_fkey" FOREIGN KEY ("decidedByUserId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
