    ...
    return (
      <main className="min-h-screen bg-slate-50">
        <section className="container mx-auto max-w-2xl px-6 py-16 text-center">
          ...
          <p className="mt-3 text-slate-600">The organiser hasn't published ticket tiers for this event.</p>
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="container mx-auto max-w-3xl px-6 py-10">
        ...
        <p className="mt-2 text-slate-600">Buy spectator tickets. Each ticket has its own QR — scan at the gate.</p>
        <TicketsForm
          slug={comp.slug}
